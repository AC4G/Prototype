 ...
 */
final class Version20220404092526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE role_ident (id INT AUTO_INCREMENT NOT NULL, roles LONGTEXT NOT NULL, UNIQUE INDEX id_UNIQUE (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_roles (id INT AUTO_INCREMENT NOT NULL, role_ident_id INT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX fk_user_roles_role_ident1_idx (role_ident_id), INDEX fk_Roles_User1_idx (user_id), UNIQUE INDEX id_UNIQUE (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
