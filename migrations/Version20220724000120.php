 ...
 */
final class Version20220724000120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, project_id INT DEFAULT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, parameter LONGTEXT NOT NULL, path LONGTEXT NOT NULL, creation_date DATETIME NOT NULL, INDEX IDX_1F1B251EA76ED395 (user_id), INDEX fk_Item_Project1_idx (project_id), UNIQUE INDEX id_UNIQUE (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE refresh_token (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, project_id INT DEFAULT NULL, refresh_token VARCHAR(255) NOT NULL, expire_date DATETIME NOT NULL, scopes LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX fk_Refresh_Token_Project1_idx (project_id), INDEX fk_Refresh_Token_User1_idx (user_id), UNIQUE INDEX id_UNIQUE (id), UNIQUE INDEX refresh_token_UNIQUE (refresh_token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
