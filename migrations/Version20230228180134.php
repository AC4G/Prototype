 ...
 */
final class Version20230228180134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chat_room (id INT AUTO_INCREMENT NOT NULL, room_type_id INT DEFAULT NULL, image_path LONGTEXT DEFAULT NULL, settings LONGTEXT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, parameter LONGTEXT DEFAULT NULL, INDEX fk_chat_room_member_chat_room_type1_idx (room_type_id), UNIQUE INDEX id_UNIQUE (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE chat_room_member (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, chat_room_id INT NOT NULL, INDEX fk_chat_room_user1_idx (user_id), INDEX fk_chat_room_member_chat_room1_idx (chat_room_id), UNIQUE INDEX id_UNIQUE (id), UNIQUE INDEX room_id_user_id_UNIQUE (user_id, chat_room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, project_id INT DEFAULT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, parameter LONGTEXT NOT NULL, path LONGTEXT NOT NULL, creation_date DATETIME NOT NULL, FULLTEXT INDEX name_fulltext (name), FULLTEXT INDEX parameter_fulltext (parameter), INDEX fk_Item_User_idx (user_id), INDEX fk_Item_Project1_idx (project_id), UNIQUE INDEX id_UNIQUE (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, developer_id INT DEFAULT NULL, project_name VARCHAR(255) NOT NULL, organisation_name VARCHAR(255) NOT NULL, organisation_email VARCHAR(255) NOT NULL, organisation_logo LONGTEXT DEFAULT NULL, support_email VARCHAR(255) NOT NULL, creation_date DATETIME NOT NULL, INDEX fk_Project_Developer1_idx (developer_id), UNIQUE INDEX id_UNIQUE (id), UNIQUE INDEX project_name_UNIQUE (project_name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE public_key (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, public_key LONGTEXT NOT NULL, creation_date DATETIME NOT NULL, UNIQUE INDEX id_UNIQUE (id), UNIQUE INDEX key_UNIQUE (public_key), UNIQUE INDEX user_UNIQUE (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE refresh_token (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, project_id INT DEFAULT NULL, refresh_token VARCHAR(255) NOT NULL, creation_date DATETIME DEFAULT NULL, expire_date DATETIME NOT NULL, scopes LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX fk_Refresh_Token_Project1_idx (project_id), INDEX fk_Refresh_Token_User1_idx (user_id), UNIQUE INDEX id_UNIQUE (id), UNIQUE INDEX refresh_token_UNIQUE (refresh_token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reset_password_token (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, code TINYTEXT NOT NULL, creation_date DATETIME NOT NULL, expireDate DATETIME NOT NULL, INDEX fk_ResetPassword_Request_User_idx (user_id), UNIQUE INDEX id_UNIQUE (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, nickname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password LONGTEXT NOT NULL, uuid VARCHAR(255) NOT NULL, profile_pic LONGTEXT DEFAULT NULL, is_private TINYINT(1) NOT NULL, email_verified DATETIME DEFAULT NULL, creation_date DATETIME NOT NULL, google_authenticator_secret VARCHAR(255) DEFAULT NULL, twofa_verified DATETIME DEFAULT NULL, UNIQUE INDEX email_UNIQUE (email), UNIQUE INDEX id_UNIQUE (id), UNIQUE INDEX nickname_UNIQUE (nickname), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_token (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, token VARCHAR(255) NOT NULL, token_type TINYTEXT NOT NULL, creation_date DATETIME DEFAULT NULL, expire_date DATETIME DEFAULT NULL, INDEX IDX_BDF55A63A76ED395 (user_id), INDEX fk_User_Id_User_Token_Type (user_id, token, token_type), UNIQUE INDEX id_UNIQUE (id), UNIQUE INDEX token_UNIQUE (token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE web_app (id INT AUTO_INCREMENT NOT NULL, oauth_client_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, redirect_url LONGTEXT DEFAULT NULL, scopes LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX fk_Web_App_OAuth_Client1_idx (oauth_client_id), UNIQUE INDEX id_UNIQUE (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE item ADD CONSTRAINT FK_1F1B251E166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) ON DELETE CASCADE');
