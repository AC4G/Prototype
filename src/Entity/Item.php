 ...
 * Item
 *
 * @ORM\Table(name="item", uniqueConstraints={@ORM\UniqueConstraint(name="id_UNIQUE", columns={"id"})}, indexes={@ORM\Index(name="name_fulltext", columns={"name"}, flags={"fulltext"}), @ORM\Index(name="parameter_fulltext", columns={"parameter"}, flags={"fulltext"}), @ORM\Index(name="parameter_name_fulltext", columns={"parameter", "name"}, flags={"fulltext"}), @ORM\Index(name="fk_Item_User_idx", columns={"user_id"}), @ORM\Index(name="fk_Item_Project1_idx", columns={"project_id"})})
